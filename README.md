...
<p>No es realmente un compilador de código en el sentido normal, pero sí que se puede considerar uno ya que junta diferentes fragmentos de código y transforma de JavaScript a JavaScript mejorado.</p>
